...
A minimal Umbraco 18 + Forms 18 site for manually exercising the package. References the `Umbraco.Community.Forms.Excel` project directly, so local changes take effect on the next run.
